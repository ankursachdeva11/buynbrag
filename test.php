...
//$installer->removeAttribute('catalog_category', 'footer_content');
$installer->addAttribute('catalog_category', 'category_footer_desc', array(
    'group'                => 'General',
    'type'              => 'text',//can be int, varchar, decimal, text, datetime
    'backend'           => '',
    'frontend_input'    => '',
    'frontend'          => '',
    'label'             => 'Category Footer Description',
