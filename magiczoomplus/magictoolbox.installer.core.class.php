<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.9.18' || 'working' == 'v4.5.33') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=commercial&tool_version=v4.5.33&module_version=v4.9.18&platform_name=magento&platform_version={$platformVersion}&url={$url}";
