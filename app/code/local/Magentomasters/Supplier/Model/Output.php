...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
    	<td><table width="100%" border="1" cellspacing="0" cellpadding="4">
        		<tbody><tr bgcolor="#CCCCCC"><td colspan="1"><h2>Supplier info</h2></td><td><img src="media/supplier/supplier_' . $supplier['name'] . '.jpg"/></td></tr>
                <tr><td><strong>Seller Name</strong></td><td>'.$supplier['surname'].'</td></tr>
				<tr><td><strong>Address</strong></td><td>'.$supplier['address1'].'<br />
'.$supplier['city'].'<br />
'.$supplier['postalcode'].'<br />
'.$supplier['state'].', '.$supplier['country'].'<br />
Contact us: 8130 878 822<br />
Email: talktous@buynbrag.com</td></tr>

        	</tbody></table></td>
    	<td>
        	<table width="100%" border = "1" cellspacing="0" cellpadding="4">
        		<tr bgcolor="#CCCCCC"><td colspan="2"><h2>Order info</h2></td></tr>
                <tr><td><strong>Order number</strong></td><td>'.$order->getIncrementId().'</td></tr>
				<tr><td><strong>Order date</strong></td><td>'.$order->getCreatedAt().'</td></tr>
				<tr><td><strong>Dropship date</strong></td><td>'.date('D, d M Y H:i:s', time()).'</td></tr>
        	</table>
        </td>
    </tr>
    ...
    <tr>
    	<td>
        	<table width="100%" border = "1" cellspacing="0" cellpadding="4">
                ...
                <tr>    
                	<td>'.$billingaddress['firstname'].' '.$billingaddress['lastname'].'<br/>

'.$billingaddress['street'].'<br />



'.$billingaddress['city'].',  '.$billingaddress['region'].', '.$billingaddress['firstname'].'<br/>
'.Mage::app()->getLocale()->getCountryTranslation($billingaddress['country_id']).'<br/>
...
Email: '.$billingaddress['email'].'
        ...
        <td>
        	<table width="100%" border = "1" cellspacing="0" cellpadding="4">
               ...
               <tr>    
                	<td>'.$shippingaddress['firstname'].' '.$shippingaddress['lastname'].'<br/>

'.$shippingaddress['street'].'<br />



'.$shippingaddress['city'].',  '.$shippingaddress['region'].', '.$shippingaddress['firstname'].'<br/>
'.Mage::app()->getLocale()->getCountryTranslation($shippingaddress['country_id']).'<br/>
...
$html.='<tr>
	...
	<td>'.$item->getName().'</td>
	<td>'.$item->getSku().'</td>
	<td>'.round($item->getQtyOrdered()).'</td>
	<td>Rs '.number_format(round($item->getPrice())).'</td>
	<td>Rs '.number_format(round($item->getPrice()*$item->getQtyOrdered())).'</td>
</tr>';
$i++;
			 }
...
<span style="
    float: right;
    margin-top: 22px;
"> Total amount payable: Rs '.number_format(round($order->getGrandTotal())).'</span><br>

<span style="float:right;margin-top:40px;"> “We hope you love what you bought!”<br>
    For further queries, please call or text our customer care team on 8130 878 822. You can also send an email totalktous@buynbrag.com</span><br />
<br />
Powered by: <img src="media/supplier/logo.jpg" style="width: 200px;"/></body> 
';
